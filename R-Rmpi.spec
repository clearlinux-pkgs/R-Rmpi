...
Version  : 0.6.9.1
Release  : 39
URL      : https://cran.r-project.org/src/contrib/Rmpi_0.6-9.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Rmpi_0.6-9.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614098538
